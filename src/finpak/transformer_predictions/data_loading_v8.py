...
from stock_dataset_v8 import StockDataset, StockFeatures
from preprocessing_v8 import create_stock_features, combine_price_series
...
def create_subset_dataloaders(
    ...
    (train_loader, val_loader,
     ...
     categorical_target_names) = create_dataloaders(
    ...
    if return_registry:
        registry = {
            ...
            'continuous_targets': continuous_target_names,
            'categorical_targets': categorical_target_names
        }
