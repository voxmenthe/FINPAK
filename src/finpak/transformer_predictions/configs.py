...
all_configs = {
    ...
    "vMP007a_stability_followon": {
        ...
        "data_params": {
            "sequence_length": 48, # vs 32
            "return_periods": [1, 2, 3, 4, 5, 8, 13, 26, 36],
            "sma_periods": [3, 7, 17, 25, 36, 46],
            "target_periods": [1, 3], # vs [1, 2]
            "use_volatility": True,
            "use_momentum": True,
            "momentum_periods": [4, 9, 15, 21, 37, 46],
            "reverse_tickers": False
        ...
        "train_params": {
            ...
            "train_subset_size": 15,
            "train_overlap": 3,
            "prefix": "vMP007a_stability_followon",
            "architecture_version": "v3",
            "run_id": "0"
        }
    },

    "vMP007a_stability_followon_2": {
        "model_params": {
            "d_model": 384,
            "n_heads": 16,
            "n_layers": 24,
            ...
            "use_multi_scale": False,
            "use_relative_pos": False,
            "temporal_scales": [2, 5, 8]
        },
        "data_params": {
            "sequence_length": 48, # vs 32
            "return_periods": [1, 2, 3, 4, 5, 8, 13, 26, 36],
            "sma_periods": [3, 7, 17, 25, 36, 46],
            "target_periods": [2, 5], # vs [1, 2]
            "use_volatility": True,
            "use_momentum": True,
            "momentum_periods": [4, 9, 15, 21, 37, 46],
            "reverse_tickers": False
        ...
        "train_params": {
            ...
            "train_subset_size": 15,
            "train_overlap": 3,
            "prefix": "vMP007a_stability_followon_2",
            "architecture_version": "v3",
            "run_id": "0"
        }
    },
